  ...
  const userData = {
    0: {
      ...
      achievements: [
        ...
        { id: 3, name: "Stage Hopper", icon: "🎤", earned: false, progress: 0.7 },
        { id: 4, name: "VIP Experience", icon: "⭐", earned: true },
        { id: 5, name: "Festival Legend", icon: "👑", earned: false, progress: 0.3 },
      ],
      recentEvents: [
        { id: 1, name: "Summer Music Festival 2025", status: "active", points: 2500 },
        { id: 2, name: "Jazz & Blues Festival", status: "completed", points: 1800 },
        { id: 3, name: "Indie Rock Weekend", status: "completed", points: 1200 },
      ],
      stats: {
        tasksCompleted: 28,
        eventsAttended: 3,
    ...
    1: {
      ...
      achievements: [
        ...
        { id: 6, name: "Sound Pioneer", icon: "🔊", earned: false, progress: 0.6 },
      ],
      recentEvents: [
        { id: 1, name: "Summer Music Festival 2025", status: "active", points: 1250 },
        { id: 2, name: "Indie Rock Weekend", status: "completed", points: 890 },
        { id: 3, name: "Jazz & Blues Festival", status: "completed", points: 650 },
        { id: 4, name: "Electronic Dance Fest", status: "completed", points: 1100 },
      ],
      stats: {
        tasksCompleted: 45,
        eventsAttended: 7,
    ...
    2: {
      ...
      achievements: [
        { id: 1, name: "Festival Starter", icon: "🎵", earned: true },
        { id: 2, name: "Music Maven", icon: "🎧", earned: true },
        { id: 3, name: "Stage Hopper", icon: "🎤", earned: false, progress: 0.8 },
        { id: 4, name: "Jazz Aficionado", icon: "🎷", earned: true },
      ],
      recentEvents: [
        { id: 1, name: "Jazz & Blues Festival", status: "active", points: 2200 },
        { id: 2, name: "Classic Jazz Night", status: "completed", points: 1500 },
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const inProgressAchievements = userData.achievements.filter((a) => !a.earned && a.progress);

    // Create the NFT metadata object according to ERC-721 standard
    const metadata = {
      name: `Mivio Music Pass #${tokenId}`,
      description: "A soulbound NFT representing your music festival journey and achievements in the Mivio ecosystem. This pass showcases your participation across various music events and festivals.",
