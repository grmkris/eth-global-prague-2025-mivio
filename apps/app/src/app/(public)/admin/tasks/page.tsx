	...
	const tasks: Task[] = [
		{
			...
			description: "Sample coffees from at least 5 different origins",
		...
		},
		{
			...
			description: "Attend a latte art or brewing technique workshop",
			location: "Workshop Stage - East Wing",
			reward: "Exclusive Coffee Blend Badge",
			rewardType: "badge",
			type: "scan",
			status: "active",
			completions: 280,
		...
		{
			id: "task-3",
			title: "Roaster Challenge",
			description: "Visit 10 different roaster booths and collect stamps",
			location: "Exhibition Hall - Roaster Row",
			reward: "Free Coffee Sampler Pack",
			rewardType: "perk",
			type: "interact",
			status: "active",
			completions: 150,
		},
		{
			...
			description: "Participate in a professional coffee cupping session",
		...
		{
			id: "task-5",
			title: "Coffee Trivia Master",
			description: "Complete the coffee knowledge quiz challenge",
			location: "Info Booth - Central Hall",
			reward: "Coffee Expert NFT",
			rewardType: "badge",
			type: "visit",
			status: "inactive",
			completions: 67,
