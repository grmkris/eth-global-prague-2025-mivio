...
import { events, eventParticipants, eventWallets, users, tasks, taskCompletions } from "~/server/db/schema";
...
export const eventRouter = createTRPCRouter({
  ...
  getAll: publicProcedure
    .input(z.object({
      status: z.enum(["all", "upcoming", "active", "completed"]).optional().default("all"),
    }))
